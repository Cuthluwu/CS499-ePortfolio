...
Run from `02_ENHANCED_SOFTWARE_DESIGN_ARTIFACT/cs320-service-suite`:
...
`04_EVIDENCE/SoftwareDesignVerification.java` provides a dependency-free check of the highest-risk behaviors. It compiles with the production source and performs 26 checks. The recorded run confirms:
