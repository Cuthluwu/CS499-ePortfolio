...
| Result protection | No result collections | Immutable lists containing record snapshots | `List.copyOf`, copy constructors, tests |
...
- `evidence/ALGORITHMS_VERIFICATION_RESULTS.txt`
