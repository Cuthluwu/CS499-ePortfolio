...
| Self-assessment introduces how artifacts fit together | Complete | “What the ePortfolio Demonstrates” section introduces all three categories and their shared engineering approach |
| Code review: existing functionality | Complete in script/page | `code-review.html` and Week 2 script analyze original CS 320 and CS 360 behavior |
...
3. Software Design artifact ZIP and narrative DOCX.
4. Algorithms artifact ZIP and narrative DOCX.
5. Databases artifact ZIP and final narrative DOCX.
6. Professional self-assessment DOCX.
7. Any course-specific submission comments needed to identify external video hosting.
