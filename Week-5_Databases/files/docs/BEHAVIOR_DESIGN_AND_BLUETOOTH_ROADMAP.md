...
The more recent review by Krukowski et al. (2024) is important because it prevents the proposal from overstating the evidence. Across 19 studies, results for feedback format and generation were mixed, and weight outcomes were too heterogeneous for a pooled conclusion. The corrected analysis found a smaller but significant effect of feedback on physical activity. Therefore, the portfolio presents adaptive feedback as a researched design hypothesis that requires usability and outcome testing, not as a guaranteed clinical intervention.
...
Web Accessibility Initiative. (2024a). *Understanding Success Criterion 1.4.1: Use of color*. World Wide Web Consortium. https://www.w3.org/WAI/WCAG22/Understanding/use-of-color.html

Web Accessibility Initiative. (2024b). *Understanding Success Criterion 1.4.3: Contrast (minimum)*. World Wide Web Consortium. https://www.w3.org/WAI/WCAG22/Understanding/contrast-minimum.html
